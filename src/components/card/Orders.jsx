        ...
        <>
            ...
            <div className="max-w-5xl mx-auto px-4 py-10">
                <div className="flex gap-4 mb-6 md:hidden text-[14px] text-[#555] border-b border-[#e2e2e2] pb-4">
                    <p onClick={() => navigate("/account")} className="cursor-pointer hover:text-black">Account</p>
                    <p onClick={() => navigate("/account/orders")} className="cursor-pointer font-medium text-black">Orders</p>
                    <p onClick={() => navigate("/logout")} className="cursor-pointer hover:text-black ml-auto">Sign Out</p>
                </div>
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        {orders.map((order) => (
                            <div key={order._id} className="border border-gray-200 rounded mb-6">
                                <div className="grid grid-cols-2 md:grid-cols-3 px-6 py-4 text-sm border-b border-gray-200">
                                    <div>
