                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    value={password} type={showPassword ? "text" : "password"} id="password" name="password" autoComplete="current-password"
                                    className="w-full bg-[#fff] rounded-[6px] border border-black/40 px-3 py-[6px] text-black text-[14px] outline-none pr-10" />
                                <button type="button"
                        ...
                        <div>
                            <button type="submit" disabled={isLoading}
                                className="bg-[#000] w-full block rounded-md py-3 text-[#fff] cursor-pointer disabled:opacity-60">
